<div class="fixed top-0 left-0 w-64 bg-white text-black border m-4 mr-0 rounded-lg overflow-hidden h-screen flex flex-col shadow-lg">
    ...
    <div class="flex flex-col h-full bg-gray-100 p-4 space-y-4 overflow-y-auto scrollbar-hide">
        ...
        <ul class="flex flex-col space-y-2">
            <!-- Dashboard -->
            <li>
                <a href="dashboard.php" class="flex items-center py-3 px-4 font-semibold rounded-lg transition-all duration-300 text-blue-950 hover:bg-[#00446b] hover:text-white">
            ...
            <li>
                <a href="competency.php" class="flex items-center py-3 px-4 font-semibold rounded-lg transition-all duration-300 text-blue-950 hover:bg-[#00446b] hover:text-white">
            ...
            <!-- Others -->
            <li>
                <details class="group" id="others">
                    <summary class="flex items-center justify-between py-3 px-4 font-semibold rounded-lg transition-all duration-300 text-blue-950 hover:bg-[#00446b] hover:text-white cursor-pointer">
                        <div class="flex items-center">
                            <i class="fas fa-cogs w-6 text-lg mr-3"></i>
                            <span>Others</span>
                        </div>
                        <i class="fas fa-chevron-down transition-transform"></i>
                    </summary>
